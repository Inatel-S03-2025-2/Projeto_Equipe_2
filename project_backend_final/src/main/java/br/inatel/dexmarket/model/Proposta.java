 ...
 * 
 * **Padrão Factory (Produto Abstrato)**: Esta classe é a classe abstrata que será estendida por diferentes
 * tipos de propostas (PropostaSimples, PropostaComItemExtra, etc.). A criação é delegada à PropostaFactory.
 */

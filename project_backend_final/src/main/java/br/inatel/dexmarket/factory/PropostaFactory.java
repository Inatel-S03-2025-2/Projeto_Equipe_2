...
/**
 * **Padrão Factory Method (Creator)**: Responsável por criar diferentes tipos de propostas de forma desacoplada.
 * 
 * Benefício: O código cliente (ex: PropostaService) não precisa conhecer as classes concretas (PropostaSimples, PropostaComItemExtra).
 * Apenas a Factory conhece como criar cada tipo, centralizando a lógica de criação.
 */

...
public interface TrocaRepository {
    ...
    /**
     * Lista todas as trocas de um jogador com um status específico.
     * 
     * @param idJogador O ID do jogador (ofertante ou proponente)
     * @param status O status da troca ("Concluída", "Ativa", etc.)
     * @return Lista de trocas do jogador com o status especificado
     */
    List<Troca> findByJogadorAndStatus(int idJogador, String status);
